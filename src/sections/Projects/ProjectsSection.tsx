...
export const ProjectListing = ({ featured, others }: ProjectListingProps) => (
  <>
    <FeaturedGrid>
...
export const ProjectsSection = ({ projects }: ProjectsSectionProps) => (
  <Section id="projects">
    <SectionInner>
      <SectionHeader>
        <SectionKicker>Progetti</SectionKicker>
        <SectionTitle>{projects.title}</SectionTitle>
        <SectionCaption>{projects.caption}</SectionCaption>
      </SectionHeader>
      <ProjectListing featured={projects.featured} others={projects.others} />
    </SectionInner>
  </Section>
)
